...
[payment_id] int  NOT NULL  
, [gateway_reference] varchar(20)  NOT NULL  
, [gateway_response] varchar(max)  NOT NULL  
, [date_created] datetime  NOT NULL  
)
GO
...
ALTER TABLE [dbo].[Invoice] WITH CHECK ADD CONSTRAINT [Currency_Invoice_FK1] FOREIGN KEY (
[currency_id]
)
